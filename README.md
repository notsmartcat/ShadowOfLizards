...
### Beheading  
A Lizard can be beheaded if hit with a Stab or Bite in the neck area. When Heheaded a Cut Head Object is created and the Lizard also gets a -50% to it's Dynamic Cheat Death Chance, if the Lizard Succedes Cheating Death it gets 25% back. The Head Object itself doesn't have any uses however it can block spears. If a Lizard survives after heing heheaded it gain's it's head back the next cycle.  
Visually the Cut Head Object uses the same sprites as the regular Lizard Head with an additional sprite at the neck area, a similar sprite is used on the Lizard in the neck area.
...
## Immunities
Immunities prevent from being affected by certain map related objects or effects.

### Worm Grass Immunity  
Can Be gained by being consumed by Worm Grass while either dead or alive. There are Currently no ways to lose the Immunity, I am open to suggestions.

### Hypothermia Immunity  
Can be gained by getting max Hypothermia while either dead or alive. There are currently no ways to lose the Immunity, I am open to suggestions!  
This Immunity is automatically given to Lizards with the Melted Transformation.

### Lava/Acid Immunity  
Can be gained by "swimming" in Lethal Water while either dead or alive. There are no ways to lose the Immunity.  
This Immunity is automatically given to Lizards with the Melted Transformation.  
If the Melted Transformation is Turned on this Immunity will not be able to be gained without getting the Transformation first however if the Melted Transfomration is turned Off or the Lizard already has any Transformation this Immunity can be gained normally without the Melted Transformation being forced.  
This Immunity allows the Lizards to at least be able to swim on top of water

### Rot Immunity  
Can Be gained by being consumed by the Rot while either dead or alive. There are Currently no ways to lose the Immunity, I am open to suggestions.

### Drowning Immunity
Can Be gained by drowning. There are Currently no ways to lose the Immunity, I am open to suggestions.
...
### Tongue  
A tongue can be Lost if the Lizard is hit in the Mouth. A Tongue can be Gained 2 different ways; firstly if a Lizard dies from falling off the map it can either gain a Tongue, when gaining the tongue this way it is chosen randomly from 5 (an additional tongue is available if either DLC is Enabled as well as a second Tongue being available with the Watcher DLC enabled) Tongue types.  
...
### Cyan Jump  
The Cyan Jump can be lost if a Gas Leak occurs, this can happen if a Lizard is hit while charging up the jump. The Jump Ability can be Gained 2 different ways; firstly if a Lizard dies from falling off the map it can gain the Cyan Jummp.  
...
### Swim Ability
There are Currently no ways to lose the Ability, I am open to suggestions. The Swim Ability can be gained if the Lizard dies by drowning or get killed by: Leeches, Kelp or Leviathan.  
...
### Wall Climbing  
There are 3 Separate Abilities associated to this, the Climbing (aka Climbing Poles), Wall (aka Climbing background walls and actual walls) and Ceiling (aka Climbing Ceilings)  
...
If a Lizard dies from falling off the map it can gain either the Wall Or Ceiling Climbing Ability, if that ability is already true it will give the Lizard the Pole climbing one.

### Camo
There are currently no ways to gain the Ability, I am open to suggestions! There are currently no ways to lose the Immunity, I am open to suggestions!  
